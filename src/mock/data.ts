...
export const mockStages: Stage[] = [
  { id: 'stage-1', name: '海选 · 小组循环赛', format: 'round_robin', status: 'running', sort_order: 1, start_at: '2026-08-01 10:00', end_at: '2026-08-07 22:00' },
  { id: 'stage-2', name: '正赛 · 单败淘汰', format: 'single_elim', status: 'upcoming', sort_order: 2, start_at: '2026-08-15 13:00', end_at: '2026-08-16 20:00' },
  { id: 'stage-3', name: '瑞士轮 · 小组赛', format: 'swiss', status: 'running', sort_order: 3, start_at: '2026-08-10 10:00', end_at: '2026-08-12 22:00' },
]
...
export const mockTeamStats: TeamStatRow[] = [
  { team_id: 'team-1', team_name: 'Nova Velocity', tag: 'NV', group_id: 'g1', group_name: '传奇组', played: 2, wins: 2, losses: 0, points: 6, we: 100, adr: 88.6, kd: 1.52, rating: 1.21 },
  { team_id: 'team-2', team_name: '赤焰战队', tag: 'RZ', group_id: 'g3', group_name: '挑战组', played: 2, wins: 2, losses: 0, points: 6, we: 100, adr: 86.1, kd: 1.41, rating: 1.14 },
  { team_id: 'team-12', team_name: '猎鹰战队', tag: 'FE', group_id: 'g1', group_name: '传奇组', played: 2, wins: 1, losses: 1, points: 3, we: 50, adr: 83.9, kd: 1.32, rating: 1.10 },
  { team_id: 'team-3', team_name: 'Strike Force', tag: 'SF', group_id: 'g2', group_name: '大师组', played: 2, wins: 2, losses: 0, points: 6, we: 100, adr: 82.4, kd: 1.18, rating: 1.08 },
  { team_id: 'team-9', team_name: '钢铁洪流', tag: 'GT', group_id: 'g2', group_name: '大师组', played: 2, wins: 1, losses: 1, points: 3, we: 50, adr: 80.7, kd: 1.08, rating: 1.04 },
  { team_id: 'team-8', team_name: '北境狼群', tag: 'BW', group_id: 'g3', group_name: '挑战组', played: 2, wins: 1, losses: 1, points: 3, we: 50, adr: 78.9, kd: 1.02, rating: 1.02 },
  { team_id: 'team-4', team_name: '午夜行动组', tag: 'MN', group_id: 'g2', group_name: '大师组', played: 2, wins: 0, losses: 2, points: 0, we: 0, adr: 76.3, kd: 0.90, rating: 0.97 },
  { team_id: 'team-6', team_name: '幽灵小队', tag: 'GH', group_id: 'g1', group_name: '传奇组', played: 2, wins: 0, losses: 2, points: 0, we: 0, adr: 74.1, kd: 0.80, rating: 0.94 },
  { team_id: 'team-5', team_name: 'Last Bullet', tag: 'LB', group_id: 'g3', group_name: '挑战组', played: 2, wins: 0, losses: 2, points: 0, we: 0, adr: 72.5, kd: 0.75, rating: 0.90 },
].map((r) => ({ ...r, ...STAGE1_META }))

// ---------------- 个人数据排行 ----------------
export const mockPlayerStats: PlayerStatRow[] = [
  { player_id: 'demo-admin', player_name: 'KillerAce', team_id: 'team-1', team_name: 'Nova Velocity', group_id: 'g1', group_name: '传奇组', matches: 2, kills: 46, deaths: 21, assists: 8, hs_rate: 54.2, rating: 1.42 },
  { player_id: 'p02', player_name: 'Headshot', team_id: 'team-1', team_name: 'Nova Velocity', group_id: 'g1', group_name: '传奇组', matches: 2, kills: 41, deaths: 24, assists: 11, hs_rate: 61.5, rating: 1.31 },
  { player_id: 'demo-player', player_name: '炎龙', team_id: 'team-2', team_name: '赤焰战队', group_id: 'g3', group_name: '挑战组', matches: 2, kills: 38, deaths: 22, assists: 7, hs_rate: 52.0, rating: 1.25 },
  { player_id: 'p01', player_name: 'RushB', team_id: 'team-1', team_name: 'Nova Velocity', group_id: 'g1', group_name: '传奇组', matches: 2, kills: 35, deaths: 26, assists: 9, hs_rate: 47.8, rating: 1.18 },
  { player_id: 'p41', player_name: '烬', team_id: 'team-2', team_name: '赤焰战队', group_id: 'g3', group_name: '挑战组', matches: 2, kills: 33, deaths: 24, assists: 10, hs_rate: 49.3, rating: 1.15 },
  { player_id: 'u9', player_name: '鹰眼', team_id: 'team-12', team_name: '猎鹰战队', group_id: 'g1', group_name: '传奇组', matches: 2, kills: 33, deaths: 25, assists: 10, hs_rate: 50.1, rating: 1.12 },
  { player_id: 'u12', player_name: '北狼', team_id: 'team-8', team_name: '北境狼群', group_id: 'g3', group_name: '挑战组', matches: 2, kills: 33, deaths: 24, assists: 9, hs_rate: 49.5, rating: 1.11 },
  { player_id: 'u3', player_name: 'Bulletz', team_id: 'team-3', team_name: 'Strike Force', group_id: 'g2', group_name: '大师组', matches: 2, kills: 34, deaths: 27, assists: 6, hs_rate: 45.6, rating: 1.09 },
  { player_id: 'u10', player_name: '战车', team_id: 'team-9', team_name: '钢铁洪流', group_id: 'g2', group_name: '大师组', matches: 2, kills: 32, deaths: 26, assists: 8, hs_rate: 46.2, rating: 1.06 },
  { player_id: 'p16', player_name: '隼', team_id: 'team-12', team_name: '猎鹰战队', group_id: 'g1', group_name: '传奇组', matches: 2, kills: 31, deaths: 27, assists: 7, hs_rate: 44.6, rating: 1.05 },
  { player_id: 'u4', player_name: '夜行者', team_id: 'team-4', team_name: '午夜行动组', group_id: 'g2', group_name: '大师组', matches: 2, kills: 31, deaths: 28, assists: 9, hs_rate: 44.7, rating: 1.02 },
  { player_id: 'p21', player_name: 'Reaper', team_id: 'team-3', team_name: 'Strike Force', group_id: 'g2', group_name: '大师组', matches: 2, kills: 30, deaths: 29, assists: 8, hs_rate: 43.1, rating: 1.01 },
  { player_id: 'u6', player_name: 'GhostZero', team_id: 'team-6', team_name: '幽灵小队', group_id: 'g1', group_name: '传奇组', matches: 2, kills: 26, deaths: 34, assists: 6, hs_rate: 40.2, rating: 0.88 },
  { player_id: 'u5', player_name: 'SkyWalker', team_id: 'team-5', team_name: 'Last Bullet', group_id: 'g3', group_name: '挑战组', matches: 2, kills: 24, deaths: 35, assists: 5, hs_rate: 39.8, rating: 0.83 },
].map((r) => ({ ...r, ...STAGE1_META }))
